...
| 11a — withholding follows the rule graph | **done**, 2 fix rounds — mechanism + withholding report, no live run | `0d55ce3..f3ba6ef` |
...
**Status: DONE.** Commits `0d55ce3..f3ba6ef`. Mechanism only — **no live run was made.**
...
**Prerequisite: Task 11a, above — DONE (`0d55ce3..f3ba6ef`).** Until it landed, a workspace handed the
