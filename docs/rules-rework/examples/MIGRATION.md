...
The engine's done criterion (spec §2) holds: 0 failed, 0 unsupported. Every pending situation is
explained by open rulings its run hit (R32/R41/R48). Every conflict is listed under "Expectation
conflicts for the owner" below, with its reasoning.
