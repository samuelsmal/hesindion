...
# .../pipeline, .../actions, .../checks, .../state and .../sheet, compiled by rulec into Tests/RulesEngineTests/Fixtures/mini-rules.json,
# pipeline-rules.json, actions-rules.json, checks-rules.json, state-rules.json and sheet-rules.json. Rerun after a change to those files or to rulec's output
