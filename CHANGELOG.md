...
- `tests/rules/golden/` — a copy of the ten hand-authored, fully-provenanced rules, the reference encoding the LLM authoring pipeline must reproduce before it is trusted with the remaining 232
