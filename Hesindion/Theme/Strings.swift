...
enum DSAStrings {
    ...
    private static let englishFallback: [String: String] = [
        ...
        "incapacitated.noActions":  "Incapacitated — no actions; at most speaking, if the GM allows.",
        "incapacitated.noDefense":  "Incapacitated — no defences.",
    ...
    private static let translations: [String: String] = [
        ...
        "incapacitated.noActions":  "Handlungsunfähig — keine Aktionen; höchstens Sprechen, wenn der Meister es erlaubt.",
        "incapacitated.noDefense":  "Handlungsunfähig — keine Verteidigung.",
